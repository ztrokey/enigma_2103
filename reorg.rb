...
#   def decrypt(messsage, key, date)
#     decrypt_message_spliter
#     decrypt_message_index
#     decrypt_split_array
#     decrypted_indexes
#     decryptor
#     # require 'pry'; binding.pry
...
#   def decrypt_message_index
#     decrypt_message_spliter.map do |letter|
#       @characters.index(letter)
#     end
#   end

#   def decrypt_split_array
#     decrypt_message_index.enum_for(:each_slice, 4).to_a
#   end
